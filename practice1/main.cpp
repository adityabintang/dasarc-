...
void hitungPromoKertas(int jumlah, double& total, string& bonus) {
    double harga = 55000;
    double diskon = 0;
...
void hitungPromoTinta(int jumlah, double& total, string& bonus) {
    double harga = 125000;
    double diskon = 0;
    int potongan = 0;
...
void hitungPromoFlashdisk(int jumlah, double& total, string& bonus) {
    double harga = 180000;
    total = jumlah * harga;
...
int main() {
    ...
    cout << "1. Kertas A4 80 gram merk PAPER (Rp. 55.000)\n";
